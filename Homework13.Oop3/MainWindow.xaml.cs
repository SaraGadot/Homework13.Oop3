...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        Storage.Clients.Add(new Client("Петя", new List<DepositCard<decimal>>() 
            {
                new DepositCard<decimal> ("1236 4598 5896 4587", 1000), 
                new DepositCard<decimal> ("1236 4785 5896 4758")
            }));
        Storage.Clients.Add(new Client("Вася", new List<DepositCard<decimal>>()
            {
                new DepositCard<decimal> ("1245 8965 1265 4589", 5_000_000)
            }));
